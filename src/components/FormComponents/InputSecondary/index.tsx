...
export default function InputSecondary({
  ...
  return (
    <div className={`flex flex-col ${componentStyle}`}>
      ...
      <div
        className={`border-[1px] border-neutral-700 rounded-lg h-14 inputContainer overflow-hidden focus-within:border-primary-900 flex items-center w-full transition-colors duration-200 ${containerStyle} ${props.disabled ? "bg-neutral-600" : "bg-transparent"
          } `}
      >
